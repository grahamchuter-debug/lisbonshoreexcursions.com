...
const path = "/guides";
const description =
  "Portugal cruise planning guides from Lisbon — Sintra, historic Lisbon, Cascais, Belém, food and passenger-type advice with realistic timings.";

export const metadata = buildMetadata({
  title: "Portugal Cruise Planning Guides from Lisbon",
  description,
  path,
  keywords: [
    "Lisbon cruise port guide",
    "Sintra from Lisbon",
    "Lisbon shore excursions guide",
    "Cascais from Lisbon",
    "Belém from Lisbon",
  ],
});
    ...
    <>
      <JsonLd
        data={[
          ...
          webPageSchema({ title: "Portugal Cruise Planning Guides from Lisbon", description, path }),
        ]}
      />
      <PageHero
        title="Portugal Cruise Planning Guides"
        subtitle="Your gateway to Portugal — Sintra, Lisbon, the Atlantic coast, Belém and practical advice for every type of cruise passenger arriving into Lisbon."
      ...
      <section className="section-padding">
        <div className="container-wide">
          ...
          <p className="section-subtitle">Authority guides to Portugal&apos;s highlights with transfer times and return-to-ship advice.</p>
