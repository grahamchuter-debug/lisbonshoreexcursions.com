...
export function HighlightArticle({ page }: { page: AttractionPage }) {
  ...
  return (
    <>
      ...
      />
      <PhotoHeroBand image={image} eyebrow="From Lisbon Cruise Port" title={page.title} subtitle={page.tagline} compact />
      ...
      <section className="section-padding">
        <div className="container-wide max-w-4xl">
          ...
          {(page.slug === "sintra-from-lisbon-cruise-port" || page.slug === "historic-lisbon-guide") && (
            <SignatureExperienceCallout
              context={page.slug === "sintra-from-lisbon-cruise-port" ? "sintra" : "lisbon"}
            />
          )}

          {related.length > 0 && (
            <div className="mt-12">
              <h2 className="section-title text-2xl mb-6">More Portugal guides</h2>
          ...
          <div className="mt-12">
            <FAQSection faqs={page.faqs} title={`${page.attractionName} from Lisbon — FAQs`} />
          </div>
          <div className="mt-12">
            <PlanningLinks />
          </div>
