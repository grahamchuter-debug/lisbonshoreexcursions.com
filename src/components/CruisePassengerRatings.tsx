const RATINGS = [
  ...
  { label: "Scenery", stars: 4 },
  { label: "Photography", stars: 5 },
  { label: "Families", stars: 5 },
  { label: "Independent Exploring", stars: 5 },
  { label: "Adventure", stars: 3 },
  ...
  return (
    <section className="section-padding bg-coastal-50 border-b border-coastal-100">
      <div className="container-wide max-w-4xl">
        <p className="section-eyebrow">Lisbon cruise port ratings</p>
        <h2 className="section-title mt-2">How Lisbon scores for cruise passengers</h2>
